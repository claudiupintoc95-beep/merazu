...
onAuthStateChanged(auth, async (user) => {
  ...
  document.getElementById("challenge-day-label").textContent = getDayName(today);
  ...
  const challengeType = getChallengeType(today);
  const challenge = getDefaultChallenge(today, challengeType);
